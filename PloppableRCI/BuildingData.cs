...
namespace PloppableRICO
{
    ...
    */
        public static BuildingTracker[] buildingData;
        ...
        public override void OnCreated(ISerializableData serializableData)
        {
            ...
            buildingData = new BuildingTracker[BuildingManager.instance.m_buildings.m_size];
        ...
        public override void OnLoadData()
        {
            ...
            {
                buildingData = DataSerializer.DeserializeArray<BuildingTracker>(stream, DataSerializer.Mode.Memory);
            }
    ...
    /// </summary>
    public class BuildingTracker : IDataContainer
    {
        public string Name;
        public int level;
